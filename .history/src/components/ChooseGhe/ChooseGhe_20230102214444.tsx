...
function ChooseGhe() {
  ...
  const [chooseQuantityNext, setChooseQuantityNext] = useState<number>(0);
  ...
  const handleK2 = () => {
    ...
    if(chooseQuantityNext === 1){
      setChooseQuantity3(1);
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li
            ...
            className={chooseQuantity1 === 1 ? "ghe-doi selected" : "ghe-doi"}
          >
            1
          </li>
          <li
          ...
          <li
            ...
            className={chooseQuantity1 === 2 || chooseQuantity1 === 3 ? "ghe-doi selected" : "ghe-doi"}
          >
            3
          </li>
          <li
            ...
            className={chooseQuantity1 === 2 ? "ghe-doi selected" : "ghe-doi"}
          >
            4
          </li>
          <li
