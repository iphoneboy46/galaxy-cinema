...
function ChooseGhe() {
  ...
  useEffect(() => {
    ...
    const J5 = document.querySelector(".J4") as HTMLElement;
    const J6 = document.querySelector(".J4") as HTMLElement;
    const J7 = document.querySelector(".J4") as HTMLElement;
    const J8 = document.querySelector(".J4") as HTMLElement;
    const J9 = document.querySelector(".J4") as HTMLElement;
    const J10 = document.querySelector(".J4") as HTMLElement;
