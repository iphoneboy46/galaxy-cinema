...
function ChooseGhe() {
  ...
  const [chooseK34, setChooseK34] = useState<string>("");
  const [chooseK56, setChooseK56] = useState<string>("");
  const [chooseK78, setChooseK78] = useState<string>("");
  const [chooseK910, setChooseK910] = useState<string>("");
...
console.log(listGheDoi);
  ...
  const handleK1 = (event: any) => {
    ...
    if(event.target.classList.contains("selected") ){
     setChooseK12("k1,k2")
    }else if(event.target.classList.contains("ghe-doi")){
      console.log("ghe doi");
      setChooseK12("")
  ...
  return (
    <div className="choose-ghe">
      <h2>CHỌN GHẾ: {listGheDoi.k12} {listGheDoi.k34}
