...
function ChooseGhe() {
  ...
  useEffect(() => {
    ...
    const G13 = document.querySelector(".G13") as HTMLElement;
    const G14 = document.querySelector(".G14") as HTMLElement;
      ...
      if (
        ...
        list.ghe.find((ga: any) => {
          switch (ga) {
            ...
            case "G13": {
              G13.classList.add("ghe-da-mua");
              break;
            }
            case "G14": {
              G14.classList.add("ghe-da-mua");
              break;
            }
