...
function ChooseGhe() {
  ...
  const [chooseList, setChooseList] = useState<any>([listGheDoiSelected]);
  ...
  useEffect(() => {
    ...
    if(chooseList.length > ve2D){
      chooseList.forEach((ve:HTMLElement)=>{
        ve.classList.remove("ghe-doi-selected");
      })
    }
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li
            ...
            className={
              chooseQuantity1 || chooseQuantity2 || chooseQuantity3
                ? "ghe-doi selected"
                : "ghe-doi"
            }
          >
