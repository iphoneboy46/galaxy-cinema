...
function ChooseGhe() {
  ...
  useEffect(() => {
    ...
    if (listGheDoiSelected.length < ve2D) {
      setChooseGhek(true);
      setChooseQuantity22(chooseGhek);
      setChooseQuantity23(chooseGhek);
      setChooseQuantity24(chooseGhek);
      setChooseQuantity25(chooseGhek);
      setChooseQuantity26(chooseGhek);
      setChooseQuantity27(chooseGhek);
      setChooseQuantity28(chooseGhek);
