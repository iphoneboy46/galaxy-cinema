...
function ChooseGhe() {
  ...
  const [chooseQuantityNext1, setChooseQuantityNext1] = useState<boolean>(false);
  const [chooseQuantityNext2, setChooseQuantityNext2] =useState<boolean>(false);
  const [chooseQuantityNext3, setChooseQuantityNext3] =useState<boolean>(false);
  const [chooseQuantityNext4, setChooseQuantityNext4] =useState<boolean>(false);
  const [chooseQuantityNext5, setChooseQuantityNext5] =useState<boolean>(false);
  const [chooseQuantityNext6, setChooseQuantityNext6] =useState<boolean>(false);
  const [chooseQuantityNext7, setChooseQuantityNext7] =useState<boolean>(false);
  const [chooseQuantityNext8, setChooseQuantityNext8] =useState<boolean>(false);
  ...
  const handleK1 = () => {
    ...
    if (ve2D === 2) {
      setChooseQuantityNext8(true);
      setChooseQuantityNext7(true);
      setChooseQuantityNext6(false);
      setChooseQuantityNext5(false);
      setChooseQuantityNext4(false);
      setChooseQuantityNext3(false);
      setChooseQuantityNext2(false);
      setChooseQuantityNext1(true);
    }
  };
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li
            ...
            className={chooseQuantity1 === 4 || chooseQuantityNext4 ? "ghe-doi selected" : "ghe-doi"}
          >
            7
          </li>
          <li
          ...
          <li
            ...
            className={chooseQuantity1 === 5 || chooseQuantityNext5 ? "ghe-doi selected" : "ghe-doi"}
          >
            9
          </li>
          <li
          ...
          <li
            ...
            className={chooseQuantity1 === 6 || chooseQuantityNext6 ? "ghe-doi selected" : "ghe-doi"}
          >
            11
          </li>
          <li
          ...
          <li
            ...
            className={chooseQuantity1 === 7  || chooseQuantityNext7 ? "ghe-doi selected" : "ghe-doi"}
          >
            13
          </li>
          <li
          ...
          <li
            ...
            className={chooseQuantity1 === 8  || chooseQuantityNext8 ? "ghe-doi selected" : "ghe-doi"}
          >
            15
          </li>
          <li
            ...
            className={chooseQuantity1 === 8  || chooseQuantityNext6 ? "ghe-doi selected" : "ghe-doi"}
          >
            16
          </li>
          <li className="ghe-bo"></li>
