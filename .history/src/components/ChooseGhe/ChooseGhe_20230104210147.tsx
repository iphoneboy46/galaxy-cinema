...
function ChooseGhe() {
  ...
  useEffect(() => {
    ...
    if (listGheDoiSelected.length > 2) {
      // quantity 2
    ...
    } else if (listGheDoiSelected.length > 3) {
       // quantity 3

       if (chooseQuantity2 && chooseQuantity22 && chooseQuantity23) {
        setChooseQuantity24(false);
        setChooseQuantity25(false);
        setChooseQuantity26(false);
        setChooseQuantity27(false);
      ...
      if (chooseQuantity2 && chooseQuantity22 && chooseQuantity24) {
        setChooseQuantity22(false);
        setChooseQuantity25(false);
        setChooseQuantity26(false);
        setChooseQuantity27(false);
      ...
      if (chooseQuantity2 && chooseQuantity22 && chooseQuantity25) {
        setChooseQuantity22(false);
        setChooseQuantity23(false);
        setChooseQuantity26(false);
        setChooseQuantity27(false);
      ...
      if (chooseQuantity2 && chooseQuantity22 && chooseQuantity26) {
        setChooseQuantity22(false);
        setChooseQuantity24(false);
        setChooseQuantity24(false);
        setChooseQuantity27(false);
      ...
      if (chooseQuantity2 && chooseQuantity22 && chooseQuantity27) {
        setChooseQuantity22(false);
        setChooseQuantity24(false);
        setChooseQuantity24(false);
        setChooseQuantity25(false);
      ...
      if (chooseQuantity2 && chooseQuantity22 && chooseQuantity28) {
        setChooseQuantity22(false);
        setChooseQuantity24(false);
        setChooseQuantity24(false);
        setChooseQuantity26(false);
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li
            ...
            className={
              chooseQuantity1 === 3 || chooseQuantity23 || chooseQuantity32
                ? "ghe-doi selected"
                : "ghe-doi"
            }
          >
