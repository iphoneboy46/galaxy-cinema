    ...
    <div className="choose-ghe">
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li onClick={()=>{handleK2()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>2</li>
          <li  className="ghe-bo"></li>
          <li onClick={()=>{handleK3()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>3</li>
          <li onClick={()=>{handleK4()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>4</li>
          <li onClick={()=>{handleK5()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>5</li>
          <li onClick={()=>{handleK6()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>6</li>
          <li onClick={()=>{handleK7()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>7</li>
          <li onClick={()=>{handleK8()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>8</li>
          <li onClick={()=>{handleK9()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>9</li>
          <li onClick={()=>{handleK10()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>10</li>
          <li onClick={()=>{handleK11()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>11</li>
          <li onClick={()=>{handleK12()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>12</li>
          <li onClick={()=>{handleK13()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>13</li>
          <li onClick={()=>{handleK14()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>14</li>
          <li onClick={()=>{handleK15()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>15</li>
          <li onClick={()=>{handleK16()}} className={chooseGheDoiActive === 1 ? "ghe-doi selected" :  "ghe-doi"}>16</li>
          <li className="ghe-bo"></li>
          <li>K</li>
        </ul>
