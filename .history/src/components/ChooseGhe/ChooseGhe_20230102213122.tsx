    ...
    <div className="choose-ghe">
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          <li>K</li>
          <li onClick={()=>{handleK1()}} className={ chooseQuantity2 === 1 ? "ghe-doi selected" :  "ghe-doi"}>1</li>
          <li onClick={()=>{handleK2()}} className={ chooseQuantity2 === 1 ? "ghe-doi selected" :  "ghe-doi"}>2</li>
