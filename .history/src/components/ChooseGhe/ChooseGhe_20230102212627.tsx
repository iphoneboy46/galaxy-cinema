    ...
    <div className="choose-ghe">
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li onClick={()=>{handleK3()}} className={chooseGheDoiActive === 2 ? || chooseQuantity2 === 1 "ghe-doi selected" :  "ghe-doi"}>3</li>
          <li onClick={()=>{handleK4()}} className={chooseGheDoiActive === 2 ? || chooseQuantity2 === 1"ghe-doi selected" :  "ghe-doi"}>4</li>
