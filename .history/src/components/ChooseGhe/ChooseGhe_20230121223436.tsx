...
function ChooseGhe() {
  ...
  useEffect(() => {
    ...
    const K6 = document.querySelector(".K6") as HTMLElement;
    const K7 = document.querySelector(".K7") as HTMLElement;
    const K8 = document.querySelector(".K8") as HTMLElement;
    const K9 = document.querySelector(".K9") as HTMLElement;
    const K10 = document.querySelector(".K10") as HTMLElement;
    const K11 = document.querySelector(".K11") as HTMLElement;
    const K12 = document.querySelector(".K12") as HTMLElement;
    const K13 = document.querySelector(".K13") as HTMLElement;
    const K14 = document.querySelector(".K14") as HTMLElement;
    ...
    listInfo.map((list: any) => {
      if (
        ...
        list.ghe.find((ga: any) => {
          switch (ga) {
            case "K1,K2": {
              K1.classList.add("ghe-da-mua");
              break;
            }
            case "K3,K4": {
              K2.classList.add("ghe-da-mua");
              break;
            }
            case "K3": {
              K3.classList.add("ghe-da-mua");
              break;
            }
            case "K4": {
              K4.classList.add("ghe-da-mua");
              break;
            }
            case "K5": {
              K5.classList.add("ghe-da-mua");
              break;
            }
            case "K6": {
              K6.classList.add("ghe-da-mua");
              break;
            }
            case "K7": {
              K7.classList.add("ghe-da-mua");
              break;
            }
            case "K8": {
              K8.classList.add("ghe-da-mua");
              break;
            }
            case "K9": {
              K9.classList.add("ghe-da-mua");
              break;
            }
            case "K10": {
              K10.classList.add("ghe-da-mua");
              break;
            }
            case "K11": {
              K11.classList.add("ghe-da-mua");
              break;
            }
            case "K12": {
              K12.classList.add("ghe-da-mua");
              break;
            }
            case "K13": {
              K13.classList.add("ghe-da-mua");
              break;
            }
            case "K14": {
              K14.classList.add("ghe-da-mua");
              break;
            }
