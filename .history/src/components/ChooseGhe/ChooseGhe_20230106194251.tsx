...
function ChooseGhe() {
  ...
  const handleG13 = (event: React.MouseEvent<HTMLElement, MouseEvent>) => {
    if(ve2D > 0 || ve2DTV > 0){
      (event.target as HTMLElement).classList.toggle("selected");
    }

    if ((event.target as HTMLElement).classList.contains("selected")) {
      setChooseG13(chooseG13);
      setChooseList([...chooseList, chooseG13]);
    } else {
      setChooseList(
        chooseList.filter((choose: string) => {
          return choose !== chooseG13;
        })
      );
    }
  ...
  const handleG14 = (event: React.MouseEvent<HTMLElement, MouseEvent>) => {
    if(ve2D > 0 || ve2DTV > 0){
      (event.target as HTMLElement).classList.toggle("selected");
    }

    if ((event.target as HTMLElement).classList.contains("selected")) {
      setChooseG14(chooseG14);
      setChooseList([...chooseList, chooseG14]);
    } else {
      setChooseList(
        chooseList.filter((choose: string) => {
          return choose !== chooseG14;
        })
      );
    }
