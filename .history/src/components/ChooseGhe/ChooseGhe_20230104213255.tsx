  ...
  useEffect(() => {
    ...
    if(ve2D === 3){
      if (listGheDoiSelected.length > 6) {
       ...
       if (chooseQuantity33 && chooseQuantity3 && chooseQuantity32 ) {
         setChooseQuantity34(false);
         setChooseQuantity35(false);
         setChooseQuantity36(false);
         setChooseQuantity37(false);
       ...
       if (chooseQuantity33 && chooseQuantity3 && chooseQuantity34) {
         setChooseQuantity33(false);
       ...
       if (chooseQuantity33 && chooseQuantity3 && chooseQuantity35) {
         setChooseQuantity37(false);
         setChooseQuantity32(false);
         setChooseQuantity34(false);
         setChooseQuantity36(false);
       ...
       if (chooseQuantity33 && chooseQuantity3 && chooseQuantity36) {
        setChooseQuantity35(false);
        setChooseQuantity32(false);
        setChooseQuantity34(false);
        setChooseQuantity37(false);
      ...
      if (chooseQuantity33 && chooseQuantity3 && chooseQuantity37) {
        setChooseQuantity35(false);
        setChooseQuantity32(false);
        setChooseQuantity34(false);
        setChooseQuantity36(false);
      ...
      if (chooseQuantity33 && chooseQuantity3 && chooseQuantity38) {
        setChooseQuantity35(false);
        setChooseQuantity32(false);
        setChooseQuantity34(false);
        setChooseQuantity36(false);
       ...
       if (chooseQuantity34 && chooseQuantity3 && chooseQuantity32){;
         setChooseQuantity33(false);
         setChooseQuantity34(false);
         setChooseQuantity35(false);
         setChooseQuantity36(false);
       ...
       if (chooseQuantity34 && chooseQuantity3 && chooseQuantity37) {
         setChooseQuantity2(false);
         setChooseQuantity24(false);
         setChooseQuantity25(false);
         setChooseQuantity26(false);
