...
function ChooseGhe() {
  ...
  const [chooseQuantity2, setChooseGheDoiActive2] = useState<number>(0);
    ...
    <div className="choose-ghe">
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li onClick={()=>{handleK2()}} className={chooseGheDoiActive === 1 || chooseGheDoiActive2 === 2 ? "ghe-doi selected" :  "ghe-doi"}>2</li>
