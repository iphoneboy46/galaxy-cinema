...
function ChooseGhe() {
  ...
  const totalGheDonTong = veContext?.veList?.totalGheDonTong as number;
  const totalGheDoiTong = veContext?.veList?.totalGheDoiTong as number;
  const tong = [totalGheDonTong, totalGheDoiTong];
  ...
  const [chooseJ3Buy, setChooseJ3Buy] = useState<boolean>(false);
  ...
  const listInfo = JSON.parse(localStorage.getItem("datve") || "{}");
  console.log(listInfo);
  console.log(info);

  useEffect(() => {
    const K1K2 = document.querySelector(".K1-K2") as HTMLElement;
    const K3K4 = document.querySelector(".K3-K4") as HTMLElement;
    const K5K6 = document.querySelector(".K5-K6") as HTMLElement;
    const K7K8 = document.querySelector(".K7-K8") as HTMLElement;
    const K9K10 = document.querySelector(".K9-K10") as HTMLElement;
    const K11K12 = document.querySelector(".K11-K12") as HTMLElement;
    const K13K14 = document.querySelector(".K13-K14") as HTMLElement;
    const K15K16 = document.querySelector(".K15-K16") as HTMLElement;
    


    const J1 = document.querySelector(".J1") as HTMLElement;
    const J2 = document.querySelector(".J2") as HTMLElement;
    const J3 = document.querySelector(".J3") as HTMLElement;
    const J4 = document.querySelector(".J4") as HTMLElement;
    const J5 = document.querySelector(".J5") as HTMLElement;
    const J6 = document.querySelector(".J6") as HTMLElement;
    const J7 = document.querySelector(".J7") as HTMLElement;
    const J8 = document.querySelector(".J8") as HTMLElement;
    const J9 = document.querySelector(".J9") as HTMLElement;
    const J10 = document.querySelector(".J10") as HTMLElement;
    const J11 = document.querySelector(".J11") as HTMLElement;
    const J12 = document.querySelector(".J12") as HTMLElement;
    const J13 = document.querySelector(".J13") as HTMLElement;
    const J14 = document.querySelector(".J14") as HTMLElement;

    const I1 = document.querySelector(".I1") as HTMLElement;
    const I2 = document.querySelector(".I2") as HTMLElement;
    const I3 = document.querySelector(".I3") as HTMLElement;
    const I4 = document.querySelector(".I4") as HTMLElement;
    const I5 = document.querySelector(".I5") as HTMLElement;
    const I6 = document.querySelector(".I6") as HTMLElement;
    const I7 = document.querySelector(".I7") as HTMLElement;
    const I8 = document.querySelector(".I8") as HTMLElement;
    const I9 = document.querySelector(".I9") as HTMLElement;
    const I10 = document.querySelector(".I10") as HTMLElement;
    const I11 = document.querySelector(".I11") as HTMLElement;
    const I12 = document.querySelector(".I12") as HTMLElement;
    const I13 = document.querySelector(".I13") as HTMLElement;
    const I14 = document.querySelector(".I14") as HTMLElement;
    ...
    const H5 = document.querySelector(".H5") as HTMLElement;
    const H6 = document.querySelector(".H6") as HTMLElement;
    const H7 = document.querySelector(".H7") as HTMLElement;
    const H8 = document.querySelector(".H8") as HTMLElement;
    const H9 = document.querySelector(".H9") as HTMLElement;
    const H10 = document.querySelector(".H10") as HTMLElement;
    const H11 = document.querySelector(".H11") as HTMLElement;
    const H12 = document.querySelector(".H12") as HTMLElement;
    const H13 = document.querySelector(".H13") as HTMLElement;
    const H14 = document.querySelector(".J14") as HTMLElement;

    const G1 = document.querySelector(".G1") as HTMLElement;
    const G2 = document.querySelector(".G2") as HTMLElement;
    const G3 = document.querySelector(".G3") as HTMLElement;
    const G4 = document.querySelector(".G4") as HTMLElement;
    const G5 = document.querySelector(".G5") as HTMLElement;
    const G6 = document.querySelector(".G6") as HTMLElement;
    const G7 = document.querySelector(".G7") as HTMLElement;
    const G8 = document.querySelector(".G8") as HTMLElement;
    const G9 = document.querySelector(".G9") as HTMLElement;
    const G10 = document.querySelector(".G10") as HTMLElement;
    const G11 = document.querySelector(".G11") as HTMLElement;
    const G12 = document.querySelector(".G12") as HTMLElement;
  
    const F1 = document.querySelector(".F1") as HTMLElement;
    const F2 = document.querySelector(".F2") as HTMLElement;
    const F3 = document.querySelector(".F3") as HTMLElement;
    const F4 = document.querySelector(".F4") as HTMLElement;
    const F5 = document.querySelector(".F5") as HTMLElement;
    const F6 = document.querySelector(".F6") as HTMLElement;
    const F7 = document.querySelector(".F7") as HTMLElement;
    const F8 = document.querySelector(".F8") as HTMLElement;
    const F9 = document.querySelector(".F9") as HTMLElement;
    const F10 = document.querySelector(".F10") as HTMLElement;
    const F11 = document.querySelector(".F11") as HTMLElement;
    const F12 = document.querySelector(".F12") as HTMLElement;
   

    const E1 = document.querySelector(".E1") as HTMLElement;
    const E2 = document.querySelector(".E2") as HTMLElement;
    const E3 = document.querySelector(".E3") as HTMLElement;
    const E4 = document.querySelector(".E4") as HTMLElement;
    const E5 = document.querySelector(".E5") as HTMLElement;
    const E6 = document.querySelector(".E6") as HTMLElement;
    const E7 = document.querySelector(".E7") as HTMLElement;
    const E8 = document.querySelector(".E8") as HTMLElement;
    const E9 = document.querySelector(".E9") as HTMLElement;
    const E10 = document.querySelector(".E10") as HTMLElement;
    const E11 = document.querySelector(".E11") as HTMLElement;
    const E12 = document.querySelector(".E12") as HTMLElement;
    ...
    const C7 = document.querySelector(".C7") as HTMLElement;
    const C8 = document.querySelector(".C8") as HTMLElement;
    const C9 = document.querySelector(".C9") as HTMLElement;
    const C10 = document.querySelector(".C10") as HTMLElement;
    const C11 = document.querySelector(".C11") as HTMLElement;
    const C12 = document.querySelector(".C12") as HTMLElement;

    const D1 = document.querySelector(".D1") as HTMLElement;
    const D2 = document.querySelector(".D2") as HTMLElement;
    const D3 = document.querySelector(".D3") as HTMLElement;
    const D4 = document.querySelector(".D4") as HTMLElement;
    const D5 = document.querySelector(".D5") as HTMLElement;
    const D6 = document.querySelector(".D6") as HTMLElement;
    const D7 = document.querySelector(".D7") as HTMLElement;
    const D8 = document.querySelector(".D8") as HTMLElement;
    const D9 = document.querySelector(".D9") as HTMLElement;
    const D10 = document.querySelector(".D10") as HTMLElement;
    const D11 = document.querySelector(".D11") as HTMLElement;
    const D12 = document.querySelector(".D12") as HTMLElement;

    const B1 = document.querySelector(".B1") as HTMLElement;
    const B2 = document.querySelector(".B2") as HTMLElement;
    const B3 = document.querySelector(".B3") as HTMLElement;
    const B4 = document.querySelector(".B4") as HTMLElement;
    const B5 = document.querySelector(".B5") as HTMLElement;
    const B6 = document.querySelector(".B6") as HTMLElement;
    const B7 = document.querySelector(".B7") as HTMLElement;
    const B8 = document.querySelector(".B8") as HTMLElement;
    const B9 = document.querySelector(".B9") as HTMLElement;
    const B10 = document.querySelector(".B10") as HTMLElement;
    const B11 = document.querySelector(".B11") as HTMLElement;
    const B12 = document.querySelector(".B12") as HTMLElement;

    const A1 = document.querySelector(".A1") as HTMLElement;
    const A2 = document.querySelector(".A2") as HTMLElement;
    const A3 = document.querySelector(".A3") as HTMLElement;
    ...
    const A11 = document.querySelector(".A11") as HTMLElement;
    const A12 = document.querySelector(".A12") as HTMLElement;
    ...
    if(listInfo.length > 0){
      listInfo.map((list: any) => {
        if (
          list.name === info.name1 &&
          list.ngay === info.date &&
          list.suatchieu === info.suatchieu && 
          list.galaxy === info.galaxy 
        ) {
          list.ghe.find((ga: any) => {
            switch (ga) {
              case "k1,k2": {
                K1K2.classList.add("ghe-da-mua");
                break;
              }
              case "k3,k4": {
                K3K4.classList.add("ghe-da-mua");
                break;
              }
              case "k5,k6": {
                K5K6.classList.add("ghe-da-mua");
                break;
              }
              case "k7,k8": {
                K7K8.classList.add("ghe-da-mua");
                break;
              }
              case "k9,k10": {
                K9K10.classList.add("ghe-da-mua");
                break;
              }
              case "k11,k12": {
                K11K12.classList.add("ghe-da-mua");
                break;
              }
              case "k13,k14": {
                K13K14.classList.add("ghe-da-mua");
                break;
              }
              case "k15,k16": {
                K15K16.classList.add("ghe-da-mua");
                break;
              }
              ...
              case "J1": {
                J1.classList.add("ghe-da-mua");
                break;
              }
              case "J2": {
                J2.classList.add("ghe-da-mua");
                break;
              }
              case "J3": {
                J3.classList.add("ghe-da-mua");
                break;
              }
              case "J4": {
                J4.classList.add("ghe-da-mua");
                break;
              }
              case "J5": {
                J5.classList.add("ghe-da-mua");
                break;
              }
              case "J6": {
                J6.classList.add("ghe-da-mua");
                break;
              }
              case "J7": {
                J7.classList.add("ghe-da-mua");
                break;
              }
              case "J8": {
                J8.classList.add("ghe-da-mua");
                break;
              }
              case "J9": {
                J9.classList.add("ghe-da-mua");
                break;
              }
              case "J10": {
                J10.classList.add("ghe-da-mua");
                break;
              }
              case "J11": {
                J11.classList.add("ghe-da-mua");
                break;
              }
              case "J12": {
                J12.classList.add("ghe-da-mua");
                break;
              }
              case "J13": {
                J13.classList.add("ghe-da-mua");
                break;
              }
              case "J14": {
                J14.classList.add("ghe-da-mua");
                break;
              }
  
  
              case "I1": {
                I1.classList.add("ghe-da-mua");
                break;
              }
              case "I2": {
                I2.classList.add("ghe-da-mua");
                break;
              }
              case "I3": {
                I3.classList.add("ghe-da-mua");
                break;
              }
              case "I4": {
                I4.classList.add("ghe-da-mua");
                break;
              }
              case "I5": {
                I5.classList.add("ghe-da-mua");
                break;
              }
              case "I6": {
                I6.classList.add("ghe-da-mua");
                break;
              }
              case "I7": {
                I7.classList.add("ghe-da-mua");
                break;
              }
              case "I8": {
                I8.classList.add("ghe-da-mua");
                break;
              }
              case "I9": {
                I9.classList.add("ghe-da-mua");
                break;
              }
              case "I10": {
                I10.classList.add("ghe-da-mua");
                break;
              }
              case "I11": {
                I11.classList.add("ghe-da-mua");
                break;
              }
              case "I12": {
                I12.classList.add("ghe-da-mua");
                break;
              }
              case "I13": {
                I13.classList.add("ghe-da-mua");
                break;
              }
              case "I14": {
                I14.classList.add("ghe-da-mua");
                break;
              }
  
              case "H1": {
                H1.classList.add("ghe-da-mua");
                break;
              }
              case "H2": {
                H2.classList.add("ghe-da-mua");
                break;
              }
              case "H3": {
                H3.classList.add("ghe-da-mua");
                break;
              }
              case "H4": {
                H4.classList.add("ghe-da-mua");
                break;
              }
              case "H5": {
                H5.classList.add("ghe-da-mua");
                break;
              }
              case "H6": {
                H6.classList.add("ghe-da-mua");
                break;
              }
              case "H7": {
                H7.classList.add("ghe-da-mua");
                break;
              }
              case "H8": {
                H8.classList.add("ghe-da-mua");
                break;
              }
              case "H9": {
                H9.classList.add("ghe-da-mua");
                break;
              }
              case "H10": {
                H10.classList.add("ghe-da-mua");
                break;
              }
              case "H11": {
                H11.classList.add("ghe-da-mua");
                break;
              }
              case "H12": {
                H12.classList.add("ghe-da-mua");
                break;
              }
              case "H13": {
                H13.classList.add("ghe-da-mua");
                break;
              }
              case "H14": {
                H14.classList.add("ghe-da-mua");
                break;
              }
  
              case "G1": {
                G1.classList.add("ghe-da-mua");
                break;
              }
              case "G2": {
                G2.classList.add("ghe-da-mua");
                break;
              }
              case "G3": {
                G3.classList.add("ghe-da-mua");
                break;
              }
              case "G4": {
                G4.classList.add("ghe-da-mua");
                break;
              }
              case "G5": {
                G5.classList.add("ghe-da-mua");
                break;
              }
              case "G6": {
                G6.classList.add("ghe-da-mua");
                break;
              }
              case "G7": {
                G7.classList.add("ghe-da-mua");
                break;
              }
              case "G8": {
                G8.classList.add("ghe-da-mua");
                break;
              }
              case "G9": {
                G9.classList.add("ghe-da-mua");
                break;
              }
              case "G10": {
                G10.classList.add("ghe-da-mua");
                break;
              }
              case "G11": {
                G11.classList.add("ghe-da-mua");
                break;
              }
              case "G12": {
                G12.classList.add("ghe-da-mua");
                break;
              }
              ...
              case "F1": {
                F1.classList.add("ghe-da-mua");
                break;
              }
              case "F2": {
                F2.classList.add("ghe-da-mua");
                break;
              }
              case "F3": {
                F3.classList.add("ghe-da-mua");
                break;
              }
              case "F4": {
                F4.classList.add("ghe-da-mua");
                break;
              }
              case "F5": {
                F5.classList.add("ghe-da-mua");
                break;
              }
              case "F6": {
                F6.classList.add("ghe-da-mua");
                break;
              }
              case "F7": {
                F7.classList.add("ghe-da-mua");
                break;
              }
              case "F8": {
                F8.classList.add("ghe-da-mua");
                break;
              }
              case "F9": {
                F9.classList.add("ghe-da-mua");
                break;
              }
              case "F10": {
                F10.classList.add("ghe-da-mua");
                break;
              }
              case "F11": {
                F11.classList.add("ghe-da-mua");
                break;
              }
              case "F12": {
                F12.classList.add("ghe-da-mua");
                break;
              }
  
              case "E1": {
                E1.classList.add("ghe-da-mua");
                break;
              }
              case "E2": {
                E2.classList.add("ghe-da-mua");
                break;
              }
              case "E3": {
                E3.classList.add("ghe-da-mua");
                break;
              }
              case "E4": {
                E4.classList.add("ghe-da-mua");
                break;
              }
              case "E5": {
                E5.classList.add("ghe-da-mua");
                break;
              }
              case "E6": {
                E6.classList.add("ghe-da-mua");
                break;
              }
              case "E7": {
                E7.classList.add("ghe-da-mua");
                break;
              }
              case "E8": {
                E8.classList.add("ghe-da-mua");
                break;
              }
              case "E9": {
                E9.classList.add("ghe-da-mua");
                break;
              }
              case "E10": {
                E10.classList.add("ghe-da-mua");
                break;
              }
              case "E11": {
                E11.classList.add("ghe-da-mua");
                break;
              }
              case "E12": {
                E12.classList.add("ghe-da-mua");
                break;
              }
  
              case "D1": {
                D1.classList.add("ghe-da-mua");
                break;
              }
              case "D2": {
                D2.classList.add("ghe-da-mua");
                break;
              }
              case "D3": {
                D3.classList.add("ghe-da-mua");
                break;
              }
              case "D4": {
                D4.classList.add("ghe-da-mua");
                break;
              }
              case "D5": {
                D5.classList.add("ghe-da-mua");
                break;
              }
              case "D6": {
                D6.classList.add("ghe-da-mua");
                break;
              }
              case "D7": {
                D7.classList.add("ghe-da-mua");
                break;
              }
              case "D8": {
                D8.classList.add("ghe-da-mua");
                break;
              }
              case "D9": {
                D9.classList.add("ghe-da-mua");
                break;
              }
              case "D10": {
                D10.classList.add("ghe-da-mua");
                break;
              }
              case "D11": {
                D11.classList.add("ghe-da-mua");
                break;
              }
              case "D12": {
                D12.classList.add("ghe-da-mua");
                break;
              }
              
  
              case "C1": {
                C1.classList.add("ghe-da-mua");
                break;
              }
              case "C2": {
                C2.classList.add("ghe-da-mua");
                break;
              }
              case "C3": {
                C3.classList.add("ghe-da-mua");
                break;
              }
              case "C4": {
                C4.classList.add("ghe-da-mua");
                break;
              }
              case "C5": {
                C5.classList.add("ghe-da-mua");
                break;
              }
              case "C6": {
                C6.classList.add("ghe-da-mua");
                break;
              }
              case "C7": {
                C7.classList.add("ghe-da-mua");
                break;
              }
              case "C8": {
                C8.classList.add("ghe-da-mua");
                break;
              }
              case "C9": {
                C9.classList.add("ghe-da-mua");
                break;
              }
              case "C10": {
                C10.classList.add("ghe-da-mua");
                break;
              }
              case "C11": {
                C11.classList.add("ghe-da-mua");
                break;
              }
              case "C12": {
                C12.classList.add("ghe-da-mua");
                break;
              }
  
  
              case "B1": {
                B1.classList.add("ghe-da-mua");
                break;
              }
              case "B2": {
                B2.classList.add("ghe-da-mua");
                break;
              }
              case "B3": {
                B3.classList.add("ghe-da-mua");
                break;
              }
              case "B4": {
                B4.classList.add("ghe-da-mua");
                break;
              }
              case "B5": {
                B5.classList.add("ghe-da-mua");
                break;
              }
              case "B6": {
                B6.classList.add("ghe-da-mua");
                break;
              }
              case "B7": {
                B7.classList.add("ghe-da-mua");
                break;
              }
              case "B8": {
                B8.classList.add("ghe-da-mua");
                break;
              }
              case "B9": {
                B9.classList.add("ghe-da-mua");
                break;
              }
              case "B10": {
                B10.classList.add("ghe-da-mua");
                break;
              }
              case "B11": {
                B11.classList.add("ghe-da-mua");
                break;
              }
              case "B12": {
                B12.classList.add("ghe-da-mua");
                break;
              }
  
              case "A1": {
                A1.classList.add("ghe-da-mua");
                break;
              }
              case "A2": {
                A2.classList.add("ghe-da-mua");
                break;
              }
              case "A3": {
                A3.classList.add("ghe-da-mua");
                break;
              }
              case "A4": {
                A4.classList.add("ghe-da-mua");
                break;
              }
              case "A5": {
                A5.classList.add("ghe-da-mua");
                break;
              }
              case "A6": {
                A6.classList.add("ghe-da-mua");
                break;
              }
              case "A7": {
                A7.classList.add("ghe-da-mua");
                break;
              }
              case "A8": {
                A8.classList.add("ghe-da-mua");
                break;
              }
              case "A9": {
                A9.classList.add("ghe-da-mua");
                break;
              }
              case "A10": {
                A10.classList.add("ghe-da-mua");
                break;
              }
              case "A11": {
                A11.classList.add("ghe-da-mua");
                break;
              }
              case "A12": {
                A12.classList.add("ghe-da-mua");
                break;
              }
  ...
  useEffect(() => {
    ...
    } else if (ve2DGD > 0 || ve2DGDTV > 0 || ve2DGDHD > 0) {
    ...
    if (ve2D > 0 && ve2DGD > 0) {
      ...
      gheDoi.forEach((ghe: HTMLElement) => {
        ghe.classList.remove("ghe-ko-the-chon");
      });
      gheDon.forEach((ghe: HTMLElement) => {
        ghe.classList.remove("ghe-ko-the-chon");
      });
    } else if (ve2D > 0 && ve2DGDTV > 0) {
      gheDoi.forEach((ghe: HTMLElement) => {
        ghe.classList.remove("ghe-ko-the-chon");
      });
      gheDon.forEach((ghe: HTMLElement) => {
    ...
    } else if (ve2D > 0 && ve2DTV > 0 && ve2DGD > 0 && ve2DGDTV > 0) {
      gheDoi.forEach((ghe: HTMLElement) => {
        ghe.classList.remove("ghe-ko-the-chon");
      });
      gheDon.forEach((ghe: HTMLElement) => {
  ...
  const handleK1 = (event: React.MouseEvent<HTMLElement, MouseEvent>) => {
    if (ve2DGD > 0 || ve2DGDTV > 0 || ve2DGDHD > 0) {
    ...
    if (ve2DGD > 0 && ve2DGDTV > 0) {
      console.log(ve2DGD);
      console.log(ve2DGDTV);
      if (listGheDoiSelected.length > totalGheDoiTong) {
        setChooseList([]);
        listGheDoiSelected.forEach((ghe: HTMLElement) => {
          ghe.classList.remove("selected");
        });
    ...
    if (ve2DGDHD > 0) {
      if (listGheDoiSelected.length > ve2DGDHD) {
        setChooseList([]);
        listGheDoiSelected.forEach((ghe: HTMLElement) => {
          ghe.classList.remove("selected");
        });
  ...
  const handleJ1 = (event: React.MouseEvent<HTMLElement, MouseEvent>) => {
    ...
    if (ve2D > 0 && ve2DTV > 0) {
      if (listGheDonSelected.length > totalGheDonTong) {
        setChooseList([]);
        listGheDonSelected.forEach((ghe: HTMLElement) => {
          ghe.classList.remove("selected");
        });
  ...
  const handleOk = () => {
    ...
    alertGhe.classList.remove("alert");
  ...
  const handleOk2 = () => {
    ...
    alertGhe2.classList.remove("alert")
    modal.style.display = "none";
    document.body.style.overflowY = "auto";
  };
  ...
  return (
    <div className="choose-ghe">
       <div className="choose-ghe-alert">
      <div className="close" onClick={handleOk}>
          X
        </div>
        <h1>Thông báo</h1>
        <p>Vui lòng chọn số ghế</p>
        <button className="btn-ok" onClick={handleOk}>OK</button>
      </div>

      <div className="choose-ghe-alert2">
      <div className="close" onClick={handleOk2}>
          X
        </div>
        <h1>Thông báo</h1>
        <p>Vui lòng chọn đủ {tongTotal} ghế</p>
        <button className="btn-ok" onClick={handleOk2}>OK</button>
      </div>
      <h2>CHỌN GHẾ: {chooseList.toString()}</h2>
