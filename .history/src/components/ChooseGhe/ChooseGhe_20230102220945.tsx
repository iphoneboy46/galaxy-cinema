      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          ...
          <li
            ...
            className={chooseQuantity1 === 1 || chooseQuantityNext ? "ghe-doi selected" : "ghe-doi"}
          ...
          <li
            ...
            className={chooseQuantity1 === 2 || chooseQuantityNext2  ?  "ghe-doi selected" : "ghe-doi"}
          >
            3
          </li>
          <li
          ...
          <li
            ...
            className={chooseQuantity1 === 3 || chooseQuantityNext3 ? "ghe-doi selected" : "ghe-doi"}
          >
            5
          </li>
          <li
