...
function ChooseGhe() {
  ...
  const [chooseGhe, setChooseGhe] = useState(0);
    ...
    <div className="choose-ghe">
      ...
      <div className="choose-ghe-content">
        <ul className="choose-ghe-content-k">
          <li>K</li>
          <li className="ghe-doi">1</li>
          <li className="ghe-doi">2</li>
          <li className="ghe-bo"></li>
          <li className="ghe-doi">3</li>
          <li className="ghe-doi">4</li>
          <li className="ghe-doi">5</li>
          <li className="ghe-doi">6</li>
          <li className="ghe-doi">7</li>
          <li className="ghe-doi">8</li>
          <li className="ghe-doi">9</li>
          <li className="ghe-doi">10</li>
          <li className="ghe-doi">11</li>
          <li className="ghe-doi">12</li>
          <li className="ghe-doi">13</li>
          <li className="ghe-doi">14</li>
          <li className="ghe-doi">15</li>
          <li className="ghe-doi">16</li>
          <li className="ghe-bo"></li>
          <li>K</li>
        </ul>
