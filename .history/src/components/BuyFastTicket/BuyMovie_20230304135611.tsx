...
function BuyMovie({
  ...
  const handleSuat = (event: ChangeEvent<HTMLSelectElement> | string): void => {
  ...
  return (
    <div className="buy-movie">
      ...
      <div className="movie-select">
        {day !== "" ? (
          <Select placeholder="Chọn suất" options={resultTimes} onChange={handleSuat} />
        ) : (
