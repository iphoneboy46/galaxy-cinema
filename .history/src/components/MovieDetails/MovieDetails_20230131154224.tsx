...
import { MovieShowingData, trailerMovie,MovieWaitingData } from "../../data/Data";
...
function MovieDetails({ name }: MovieDetailsProps) {
  ...
  useEffect(() => {
    function checkTime() {
      ...
      MovieShowingData.map((mv) => {
        return mv.galaxyKDV?.map((nd:any) => {
          if (nd.time >= time) {
      ...
      MovieShowingData.map((mv) => {
        return mv.galaxyHTP?.map((nd:any) => {
          if (nd.time >= time) {
      ...
      MovieShowingData.map((mv) => {
        return mv.galaxyNVQ?.map((nd:any) => {
          if (nd.time >= time) {
      ...
      MovieShowingData.map((mv) => {
        return mv.galaxyBMT?.map((nd:any) => {
          if (nd.time >= time) {
