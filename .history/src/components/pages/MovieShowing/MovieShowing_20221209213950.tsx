    ...
    <div className="movie-showing-container">
      ...
      <div className="movie-showing-description">
        ...
        <p>
          ...
          chu nhất. <br />
          <br />
          Có thể thấy <strong>Avatar 2</strong> hứa hẹn sẽ là siêu phẩm được mong chờ nhất trong
          ...
          2019. <strong>Black Panther: Wakanda Forever</strong> phải thay đổi bởi vì thế giới mất
          đi diễn viên Chadwick Boseman. Ngôi sao đoản mệnh đã thổi hồn vào nhân
          vật Báo Đen, đưa ông hoàng Wakanda bước ra từ comic và trở thành nguồn
          cảm hứng cho rất nhiều người dân da màu. <br /><br />
          Thông qua teaser đầu tiên,
          ...
          chiến với Namor vùng Atlantis. <br /><br />
           Sau đỉnh điểm ở cuộc chiến đánh bại
          ...
          đà. <br /><br />
          Là bộ phim kết thúc Phase 4, <strong>Wakanda Forever</strong> gánh trách nhiệm nặng
