    ...
    <div className="comment-movie">
      <div className="comment-movie-left">
        ...
        <div className="comment-movie-left-item">
          <div className="comment-movie-item-left-img">
            <div>
              <img
          ...
          <div className="comment-movie-item-left-right">
            <a
              className="comment-movie-a"
              href="https://www.galaxycine.vn/binh-luan-phim/review-black-panther-wakanda-forever-bao-den-tim-duoc-nguoi-ke-vi-xung-dang"
            >
              [Review] Black Panther Wakanda Forever: Báo Đen Tìm Được Người Kế Vị
              Xứng Đáng?
            </a>
        ...
        <div className="comment-movie-left-item">
          ...
          <div className="comment-movie-left-item-right">
            ...
            <div className="comment-movie-left-item-des">
              <div className="comment-movie-left-item-like">
                <div className="like">
                  <i className="fa-solid fa-thumbs-up"></i>
                  Thích 1.6k
                </div>
              </div>
              <div className="comment-movie-left-item-view">
                <i className="fa-regular fa-eye"></i>
                2733
              </div>
              <div className="comment-movie-item-rating">
            ...
            <div className="comment-movie-item-tt">
              15 năm kể từ ngày được chọn diễn<strong> Black Adam</strong>, Dwayne
              Johnson và các nhà làm phim WB rốt cuộc đã thành công đưa gã mặc đồ
              đen lên màn ảnh rộng.
            </div>
          </div>
        </div>
        <div className="comment-movie-left-item">
          <div className="comment-movie-item-img">
            <div>
              <img
          ...
          <div className="comment-movie-item-right">
            <a
              className="comment-movie-a"
              href="https://www.galaxycine.vn/binh-luan-phim/co-gai-tu-qua-khu-dap-do-hoan-toan-gai-gia-lam-chieu"
            >
            ...
            <div className="comment-movie-item-tt">
            <strong>Cô Gái Từ Quá Khứ</strong> giúp bộ đôi Bảo Nhân – Nam Cito mở màn Vũ trụ Mỹ Nhân thành công nhưng lại "vắt chanh bỏ vỏ” Vũ trụ Gái Già?
            </div>
          </div>
        </div>
        <div className="comment-movie-left-item">
