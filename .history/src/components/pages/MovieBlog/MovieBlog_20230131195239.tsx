...
function MovieBlog() {
  return (
    <div className="movie-blog">
      ...
      <div className="movie-blog-left-item">
        ...
        <div className="movie-blog-left-item-right">
          ...
          <div className="movie-blog-item-tt">
            Hãy cùng điểm danh những tựa phim từng chịu số phận “ngâm kho” trong
            lịch sử!
          </div>
        </div>
      </div>
      ...
      <div className="movie-blog-item">
        <div className="movie-blog-item-img">
          <div>
            <img
        ...
        <div className="movie-blog-item-right">
          <a
            className="movie-blog-a"
            href="https://www.galaxycine.vn/movie-blog/boc-trung-phuc-sinh-black-panther-wakanda-forever"
          >
      ...
      <div className="movie-blog-item">
        ...
        <div className="movie-blog-item-right">
          ...
          <div className="movie-blog-item-tt">
            <strong> Avatar: The Way Of Water</strong> dự kiến ra mắt vào tháng
            12.2022. Trước khi có cơ hội chiêm ngưỡng hành tinh Pandora tuyệt
            đẹp, hãy cùng khám phá một số thông tin hậu trường thú vị về Avatar.
          </div>
        </div>
      </div>
      </div>
