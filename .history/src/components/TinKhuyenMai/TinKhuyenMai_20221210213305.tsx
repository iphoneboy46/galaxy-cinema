        ...
        <div className="list-khuyen-mai-item">
            ...
            <a className="list-khuyen-mai-a" href="https://www.galaxycine.vn/khuyen-mai/zalopay-tang-25k-khi-dat-ve-galaxy">
                <div>
                    ...
                    <p>Trong không khí tưng bừng chào đón mùa lễ hội lớn nhất năm Galaxy Education hợp tác cùng Galaxy Cinema mang đến cho các khách hàng những ưu đãi siêu to khổng lồ</p>
                </div>
                <button>
                chi tiết
                </button>
