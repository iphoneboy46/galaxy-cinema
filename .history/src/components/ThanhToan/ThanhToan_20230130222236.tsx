...
function ThanhToan({ choosePage }: ThanhToanProps) {
  ...
  const handleThanhToan = () => {
    ...
    const alert2 = document.querySelector(".thanh-toan-alert1") as HTMLElement;
  ...
  const handleExits2 = () => {
    const alert2 = document.querySelector(".thanh-toan-alert2") as HTMLElement;
    const modal = document.querySelector(".modal") as HTMLElement;
    

    alert2.classList.remove("alert");
    modal.style.display = "none";
  ...
  return (
    <div className="thanh-toan">
      <div className="thanh-toan-alert1">
        ...
        <button onClick={handleExits1}>OK</button>
      </div>
      <div className="thanh-toan-alert2">
        <div className="close" onClick={handleExits1}>
          X
        </div>
        <h2>Thông báo</h2>
        <p>Bạn đã đặt vé thành công</p>
        <button onClick={handleExits2}>OK</button>
      </div>
