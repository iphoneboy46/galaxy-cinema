...
function Information({ choosePage, page }: InformationProps) {
  ...
  const handleNextPage = () => {
    ...
    const alertVe2 = document.querySelector(".book-ticket-alert-2") as HTMLDivElement;
    ...
    if(totalTongGheDoi > 4 || totalTongGheDon > 8){
      alertVe2.style.top = "5%";
      alertVe2.style.opacity = "1";
      modal.style.display = "block";
      document.body.style.overflowY = "hidden";
      choosePage(1);
    }else{
