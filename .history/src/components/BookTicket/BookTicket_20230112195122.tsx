  ...
  return (
    <div className="book-ticket">
      ...
      <div className="book-ticket-alert-2">
        <h1>Thông báo</h1>
        <p>Bạn không được mua quá 8 vé

Xem thêm tại: https://www.galaxycine.vn/book-ticket/avatar-the-way-of-water?cinemaId=1001&sessionId=183946</p>
        <button className="btn-ok" onClick={handleOk}>OK</button>
      </div>
