...
function BookTicket() {
  ...
  const totalGheDoiTong = totalGheDoi.reduce((tong,sum)=>{
    return sum += tong
  })
  ...
  useEffect(() => {
    const veList: {
      ...
      totalGheDonTong?: number;
      totalGheDoiTong?: number;
      ...
      totalGheDonTong: totalGheDonTong,
      totalGheDoiTong: totalGheDoiTong
    };
  ...
  return (
    <div className="book-ticket">
      ...
      <div className="book-ticket-alert-2">
      <div className="close" onClick={handleOk2}>
          X
        </div>
        <h1>Thông báo</h1>
        <p>Bạn không được mua quá 8 vé</p>
