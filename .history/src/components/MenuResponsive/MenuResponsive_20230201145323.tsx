...
const handleDienAnh = () =>{
    const menuChildrenDienAnh = document.querySelector(".menu-goc-dien-anh-item") as HTMLElement;
    menuChildrenDienAnh?.classList.toggle("show");
}

const handleSuKien = () =>{
    const menuChildrenSuKien = document.querySelector(".menu-su-kien-item") as HTMLElement;
...
function MenuResponsive() {
  ...
  return (
    <div className="menu-responsive">
      <div className="menu-responsive-exits">
