...
import PageMuaVe from "../components/PageMuaVe/PageMuaVe";
import ChinhSach from "../components/pages/ChinhSach/ChinhSach";
...
export const publicRoutes = [
    ...
    {
        path: '/rap-giave' , component: RapGiaVe
    },
    {
        path: '/gop-y' , component: Support
    },
    {
        path: '/chinhsach' , component: ChinhSach
    },
    {
        path: `/dat-ve/:nameUrl` , component: DatVe
    },
    {
        path: `/book-ticket/:nameUrl` , component: PageMuaVe
    },
]