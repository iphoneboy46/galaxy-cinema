...
import logoGalaxyMB from "../../asset/image/galaxy-logo-mobile.png";
...
function Header() {
  ...
  const handleMenu = () =>{
    const menu = document.querySelector(".header__name--menu") as HTMLDivElement;
  ...
  const handleSignOut = () =>{
    ...
    localStorage.setItem("user", JSON.stringify(userNone));
              
    userContext.setAccount(JSON.parse(localStorage.getItem("user") || "{}"));
  }
        ...
        <div className="header__top--right">
          {name ? (
            <div className="header__name">
              ...
              <div onClick={handleMenu} className="header__name--list">
                {" "}
                <h4>{name}</h4>
              </div>
              <i className="fa-solid fa-chevron-down" onClick={handleMenu}></i>
              <div className="header__name--menu">
                <ul>
                  <li>Tài khoản</li>
          ...
          <div onClick={handleMenuRes} className="header__menu--bar">
